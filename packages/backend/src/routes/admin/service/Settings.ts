			...
			settings: z
				.array(
					z.object({
						...
						notice: z.string().describe('The notice of the setting, if any.'),
						example: z.string().describe('An example value of the setting.'),
						category: z.string().describe('The category of the setting.')
					})
				)
