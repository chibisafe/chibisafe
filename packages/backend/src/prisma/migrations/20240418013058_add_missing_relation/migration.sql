...
CREATE TABLE "new_shortenedLinks" (
    "id" INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
    "uuid" TEXT NOT NULL,
    "userId" INTEGER,
    ...
    CONSTRAINT "shortenedLinks_userId_fkey" FOREIGN KEY ("userId") REFERENCES "users" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
INSERT INTO "new_shortenedLinks" ("createdAt", "destination", "id", "identifier", "userId", "uuid", "views") SELECT "createdAt", "destination", "id", "identifier", "userId", "uuid", "views" FROM "shortenedLinks";
DROP TABLE "shortenedLinks";
ALTER TABLE "new_shortenedLinks" RENAME TO "shortenedLinks";
