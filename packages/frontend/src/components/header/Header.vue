<template>
	<div class="flex w-full h-auto items-center mt-8 max-w-4xl mobile:flex-col">
		...
		>
			<router-link v-if="!loggedIn" to="/login" class="text-light-100 hover:text-blue-500 text-lg mobile:text-xl"
			...
			<router-link
				...
				class="text-light-100 hover:text-blue-500 text-lg mobile:text-xl"
