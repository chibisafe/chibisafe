<template>
	...
	<!-- We only want to show the page after the call to settingsStore.get() has finished -->
	<template v-if="maxFileSize">
		...
		>
			It seems you are using the admin account but haven't changed the default password yet. Go to the dashboard
			and change it.
		</div>
		<div
	...
	<template v-else>
		<div class="bg-dark-100 flex w-full h-full items-center justify-center">
